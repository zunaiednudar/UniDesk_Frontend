...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-full flex inter">
            ...
            <div className="w-full max-w-full lg:max-w-[50%] min-h-screen border border-solid border-red flex flex-col items-center justify-center">
                <p className="playfair font-extrabold text-black text-5xl mb-5">Sign In</p>
                <p className="text-gray-400 mb-10">Please enter your university credentials</p>
                ...
                <div className="w-full max-w-[500px] flex items-center gap-2 text-sm mb-5">
                    ...
                    <p className="w-full text-gray-400 font-medium">OR LOGIN WITH EMAIL</p>
                    <div className="w-full bg-gray-400 h-[1px]"></div>
                </div>
                ...
                <form onSumbit={handleLogin} className="w-full max-w-[500px] mb-10">
                    ...
                    <fieldset className="fieldset">
                        ...
                        <input type="text" name="email" className="input w-full" placeholder="email@kuet.ac.bd" />
                    </fieldset>
                ...
                <div className="text-sm">Dont have an account? <Link to="" className="text-blue-500 font-medium">Create Account</Link></div>
            </div>
        </div>
    );
};
