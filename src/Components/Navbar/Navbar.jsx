...
const Navbar = () => {
    ...
    const activeClass = "text-[#1E40AF] font-semibold";
    const normalClass = "text-gray-500 hover:text-[#1E40AF] font-semibold transitions-colors ease";

    return (
        <div className="gilroy w-full max-w-full shadow-2xl bg-white h-25 sticky top-0 z-51 flex items-center">
            <nav className='w-full max-w-360 mx-auto flex justify-between px-5'>
                ...
                <NavLink to="/" className='flex items-center gap-2'>
                    ...
                    <span className='graphik text-2xl font-medium'>UniDesk</span>
                </NavLink>
                ...
                <div className={`absolute font-medium top-[100px] left-0 w-full bg-white flex flex-col items-center py-[24px] shadow-lg lg:hidden gap-[24px] z-51 transform transition-all duration-300 ease-in-out
