...
const Footer = () => {
    ...
    return (
        <footer className="gilroy bg-gray-900 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-4">
                    ...
                    <div className="flex flex-col gap-3">
                        <NavLink to="/home" className='flex items-center gap-2'>
                            <div className='w-9 h-9 bg-blue-500 rounded-lg flex justify-center items-center'>
                                <GraduationCap className='w-6 h-6 text-white' />
                            </div>
                            <span className='graphik text-lg font-regular text-white'>UniDesk</span>
                        </NavLink>
                    ...
                    {/*Quick Links Section*/}
                    <div>
                        <h4 className="graphik text-lg font-regular mb-4 text-white cursor-default">Quick Links</h4>
                    ...
                    {/*Contact Section*/}
                    <div>
                        <h4 className="graphik text-lg font-regular mb-4 text-white cursor-default">Contact</h4>
                    ...
                    {/*Follow Us Section*/}
                    <div>
                        <h4 className="graphik text-lg font-regular mb-4 text-white cursor-default">Follow Us</h4>
