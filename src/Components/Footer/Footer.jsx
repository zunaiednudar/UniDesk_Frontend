            ...
            <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-4">
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            <span className="text-gray-300 text-sm leading-relaxed">info@unidesk.edu.bd</span>
                        </li>
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            <span className="text-gray-300 text-sm leading-relaxed">+880 123 456 7890</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-3">
                        {/* Facebook */}
                        <a href={link_facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-600 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-colors duration-300">
                        ...
                        {/* Twitter */}
                        <a href={link_twitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-600 hover:bg-blue-400 rounded-lg flex items-center justify-center transition-colors duration-300">
                            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* LinkedIn */}
                        <a href={link_linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-600 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-colors duration-300">
                            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Instagram */}
                        <a href={link_instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-600 hover:bg-blue-400 rounded-lg flex items-center justify-center transition-colors duration-300">
                            <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
